...
\begin{description*}
  ...
  \item[Testiranje na terenu:] TODO (upm2015/mine)
\end{description*}
\cpp{ts/binomial.cpp}
...
\label{sec:binommod}
\begin{description*}
  \item[Vhod:] Števili $n, k \in \Z$ in $p \in \N$, ki v praštevilskem razcepu
    nima potenc praštevil.
  \item[Izhod:] Ostanek pri deljenju binomskega koeficienta $\binom{n}{k}$ s
    ...
    $k$ v $p$-jiškem sistemu. Sicer število razcepimo na tuja si števila
    (prafaktorje) in uporabimo skupaj z kitajskim izrekom o ostankih.
