...
\begin{itemize*}
  ...
  \item popucaj podatke med testnimi primeri
\end{itemize*}
...
\subsection{Fenwick tree ($\mathbf n$-dim)}
...
\begin{description*}
  ...
  \item[Časovna zahtevnost:] kumulativna vsota in update $O(\log(d_1 + \dots + d_n))$, za vsoto podkvadra
    $O(2^d\log(d_1+\dots+d_n))$.
